...
% ==============================================================================
% 🎯 TARGET POSITION & COMPANY (Customize for each application)
% ==============================================================================
...
% ==============================================================================
\begin{center}
  \textbf{\Huge \candidateName} \\ \vspace{4pt}
  \small \candidatePhone\ $|$ \href{mailto:\candidateEmail}{\candidateEmail} $|$
...
% CUSTOMIZE: Introductory paragraph with your goal and education
I am writing to express my interest in the \textbf{\targetRole} position. I am a \textbf{Computer Science student at UFABC} whose profile bridges academic mathematical depth, pragmatic software engineering, low-level systems, and cloud infrastructure.

% CUSTOMIZE: Highlight your technical mindset and fit
...
% CUSTOMIZE: Concrete practical projects and accomplishments
...
% CUSTOMIZE: Academic honors, competitions, and working methodology
...
% CUSTOMIZE: Conclusion and call to action
I believe this versatility---uniting mathematical modeling, low-level systems, scalable infrastructure, and rapid learning---qualifies me to make an immediate impact at \targetCompany. I am available for an interview at your convenience.
