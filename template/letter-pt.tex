...
% ==============================================================================
% 🎯 DADOS DA VAGA E EMPRESA (Altere para cada candidatura)
% ==============================================================================
...
% PERSONALIZAR: Parágrafo introdutório com seu objetivo e formação
Escrevo para expressar meu interesse na vaga de \textbf{\targetRole}. Sou estudante de \textbf{Ciência da Computação na UFABC}, com um perfil que une a densidade matemática e acadêmica à engenharia de software pragmática, sistemas de baixo nível e infraestrutura em nuvem.

% PERSONALIZAR: Destaque sua abordagem técnica e compatibilidade com a vaga
...
% PERSONALIZAR: Exemplos práticos de projetos e realizações técnicas
...
% PERSONALIZAR: Conquistas, premiações e metodologia de trabalho
...
% PERSONALIZAR: Fechamento e chamada para ação
Acredito que essa versatilidade — unindo modelagem matemática, sistemas de baixo nível, infraestrutura escalável e aprendizado acelerado — me qualifica para gerar impacto imediato nos desafios da \targetCompany. Estou à disposição para uma entrevista.
